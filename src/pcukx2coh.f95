...
subroutine pc_ukx2coh(Nx,Ny,Nh,pi,time,nk,ukx,ukx_new,uky,dn_dt,dux_dt,duy_dt)
implicit none
...
do i = 1,Nh
  ...
  call derive2coh(Nx,Ny,Nh,pi,time+dt,nk,dum_ukx,uky, &
