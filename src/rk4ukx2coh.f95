...
subroutine rk4_ukx2coh(Nx,Ny,Nh,pi,time,nk,ukx,ukx_new,uky,dn_dt,dux_dt,duy_dt)
implicit none
...
do i = 1,Nh
  ...
  call derive2coh(Nx,Ny,Nh,pi,time+dt/2.0d0,nk,dum_ukx,uky, &
